...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/redistribute/'
      self.save_model_dir = learning_path+'models/redistribute/'
      self.mem_address = learning_path+'models/redistribute/'
      self.eval_address = learning_path+'models/redistribute'
      self.test_address = learning_path+'models/redistribute/iteration_313/'
