...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/static_red/'
      self.save_model_dir = learning_path+'models/static_red/'
      self.mem_address = learning_path+'models/static_red/'
      self.eval_address = learning_path+'models/static_red'
      self.test_address = learning_path+'models/static_red/'
