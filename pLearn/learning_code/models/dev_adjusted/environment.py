...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/dev_adjusted/'
      self.save_model_dir = learning_path+'models/dev_adjusted/'
      self.mem_address = learning_path+'models/dev_adjusted/'
      self.eval_address = learning_path+'models/dev_adjusted'
      self.test_address = learning_path+'models/dev_adjusted/iteration_0/'
