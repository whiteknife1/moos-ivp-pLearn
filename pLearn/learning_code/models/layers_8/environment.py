...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/layers_8/'
      self.save_model_dir = learning_path+'models/layers_8/'
      self.mem_address = learning_path+'models/layers_8/'
      self.eval_address = learning_path+'models/layers_8'
      self.test_address = learning_path+'models/layers_8/'
