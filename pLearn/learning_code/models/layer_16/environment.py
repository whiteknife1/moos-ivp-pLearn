...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/layer_16/'
      self.save_model_dir = learning_path+'models/layer_16/'
      self.mem_address = learning_path+'models/layer_16/'
      self.eval_address = learning_path+'models/layer_16'
      self.test_address = learning_path+'models/layer_16/'
