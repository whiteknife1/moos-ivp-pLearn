...
class Constants:
   def __init__(self):
      ...
      self.num_test_iters = 10000
      self.num_eval_iters = 10000
      ...
      self.save_model_dir = learning_path+'models/eval_10000/'
      self.mem_address = learning_path+'models/eval_10000/'
      self.eval_address = learning_path+'models/eval_10000'
