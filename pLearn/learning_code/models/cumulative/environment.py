...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/cumulative/'
      self.save_model_dir = learning_path+'models/cumulative/'
      self.mem_address = learning_path+'models/cumulative/'
      self.eval_address = learning_path+'models/cumulative'
      self.test_address = learning_path+'models/cumulative/'
