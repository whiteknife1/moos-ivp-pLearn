...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/mod_dev_test/'
      self.save_model_dir = learning_path+'models/mod_dev_test/'
      self.mem_address = learning_path+'models/mod_dev_test/'
      self.eval_address = learning_path+'models/mod_dev_test'
      self.test_address = learning_path+'models/mod_dev_test/'
