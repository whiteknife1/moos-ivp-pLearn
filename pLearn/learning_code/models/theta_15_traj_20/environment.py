...
class Constants:
   def __init__(self):
      ...
      self.num_test_iters = 2000
      self.num_eval_iters = 2000
      ...
      self.load_model_dir = learning_path+'models/theta_15_traj_2000/'
      self.save_model_dir = learning_path+'models/theta_15_traj_2000/'
      self.mem_address = learning_path+'models/theta_15_traj_2000/'
      self.eval_address = learning_path+'models/theta_15_traj_2000'
      self.test_address = learning_path+'models/theta_15_traj_2000/'
