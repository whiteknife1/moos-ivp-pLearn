...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/actor_fit_v1/'
      self.save_model_dir = learning_path+'models/actor_fit_v1/'
      self.mem_address = learning_path+'models/actor_fit_v1/'
      self.eval_address = learning_path+'models/actor_fit_v1'
      self.test_address = learning_path+'models/actor_fit_v1/iteration_25/'
