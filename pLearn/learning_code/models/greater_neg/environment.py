...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/greater_neg/'
      self.save_model_dir = learning_path+'models/greater_neg/'
      self.mem_address = learning_path+'models/greater_neg/'
      self.eval_address = learning_path+'models/greater_neg'
      self.test_address = learning_path+'models/greater_neg/iteration_165/'
