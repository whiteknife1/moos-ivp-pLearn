...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/static_3/'
      self.save_model_dir = learning_path+'models/static_3/'
      self.mem_address = learning_path+'models/static_3/'
      self.eval_address = learning_path+'models/static_3'
      self.test_address = learning_path+'models/static_3/'
