...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/dev_test_no_rand/'
      self.save_model_dir = learning_path+'models/dev_test_no_rand/'
      self.mem_address = learning_path+'models/dev_test_no_rand/'
      self.eval_address = learning_path+'models/dev_test_no_rand'
      self.test_address = learning_path+'models/dev_test_no_rand/'
