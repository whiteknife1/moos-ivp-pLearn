...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/DQL_baseline/'
      self.save_model_dir = learning_path+'models/DQL_baseline/'
      self.mem_address = learning_path+'models/DQL_baseline/'
      self.eval_address = learning_path+'models/DQL_baseline'
      self.test_address = learning_path+'models/DQL_baseline/iteration_6/'
