...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/theta_30_traj_8/iteration_29/'
      self.save_model_dir = learning_path+'models/theta_30_traj_8/'
      self.mem_address = learning_path+'models/theta_30_traj_8/'
      self.eval_address = learning_path+'models/theta_30_traj_8'
      self.test_address = learning_path+'models/theta_30_traj_8/'
