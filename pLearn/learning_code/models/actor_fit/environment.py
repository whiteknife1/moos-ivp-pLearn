...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/actor_fit/'
      self.save_model_dir = learning_path+'models/actor_fit/'
      self.mem_address = learning_path+'models/actor_fit/'
      self.eval_address = learning_path+'models/actor_fit'
