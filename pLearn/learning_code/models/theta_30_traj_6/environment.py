...
class Constants:
   def __init__(self):
      ...
      self.load_model_dir = learning_path+'models/theta_30_traj_6/'
      self.save_model_dir = learning_path+'models/theta_30_traj_6/'
      self.mem_address = learning_path+'models/theta_30_traj_6/'
      self.eval_address = learning_path+'models/theta_30_traj_6'
      self.test_address = learning_path+'models/theta_30_traj_6/'
