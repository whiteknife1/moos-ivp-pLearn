...
##################################################################################################################
    ...
    def train_critic(self, data):
        for d in data:
            ...
            # Video method
            print("--------State-------")
            print(self.state2vec(cur_state))
            print(len(self.state2vec(cur_state)))
            print("--------Action-------")
            print(self.state2vec(action))
            print(len(self.state2vec(action)))
